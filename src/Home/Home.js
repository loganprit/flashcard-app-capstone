...
const Home = () => {
  ...
  useEffect(() => {
    ...
    // Cleanup function to aborts any pending requests
      ...
      <div className="row">
        {decks.map((deck) => (
          <div key={deck.id} className="col-sm-12 col-md-6 col-lg-4 mt-4">
            <div className="card mb-3"> {/* mb-3 adds margin to the bottom of the card */}
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between mt-3"> {/* Align buttons */}
                  <div>
                    ...
                    <span className="oi oi-book"></span> {/* For Study icon */}
                      Study
                    </Link>
                  </div>
                  <button
